...
<h2>Latihan 2</h2>
<h6>03-09-2021 10:39:02</h6>
    <canvas id="myCanvas" width="1000" height="500"></canvas>
    <script> //Java
      var canvas = document.getElementById('myCanvas');
      var context = canvas.getContext('2d'); //Jenis gambar yg digunakan -->2D
...
ctx.fillRect(445,200,300,80);
      ...
      context.fillText('☁       ☁', 375, 215);

      context.font = '35pt quicksand';
      context.fillStyle = 'black';
      context.fillText('Rumah Della', 450, 250);
